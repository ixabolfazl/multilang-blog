! function (e) {
    ...
    jQuery(document).on("ready", function () {
        ...
        jQuery(".mean-menu").meanmenu({
            ...
            autoplayHoverPause: !0,
            autoplay: !0,
            navText: ["<i class='icofont-rounded-right'></i>","<i class='icofont-arrow-left'></i>"],
            responsive: {
                0: {
                    items: 1
                },
            ...
            var o, s, a, t, n, i, l;
            o = new Date("September 30, 2019 17:00:00 PDT"), o = Date.parse(o) / 1e3, s = new Date, a = o - (s = Date.parse(s) / 1e3), t = Math.floor(a / 86400), n = Math.floor((a - 86400 * t) / 3600), i = Math.floor((a - 86400 * t - 3600 * n) / 60), l = Math.floor(a - 86400 * t - 3600 * n - 60 * i), n < "10" && (n = "0" + n), i < "10" && (i = "0" + i), l < "10" && (l = "0" + l), e("#days").html(t + "<span>Days</span>"), e("#hours").html(n + "<span>Hours</span>"), e("#minutes").html(i + "<span>Minutes</span>"), e("#seconds").html(l + "<span>Seconds</span>")
