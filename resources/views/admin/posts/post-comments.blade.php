                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <ul class="nav nav-pills" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center @if(!isset(request()->approved)) active @endif" href="{{ route('admin.posts.comments',$post->id) }}">
                                    <i data-feather='message-square'></i><span class="d-none d-sm-block">{{__('All Comments')}}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center @if(request()->approved=='1') active @endif" href="{{ route('admin.posts.comments',[$post->id,'approved'=>1]) }}">
                                    <i data-feather='message-square'></i><span class="d-none d-sm-block">{{__('Approved Comments')}}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center @if(request()->approved=='0') active @endif" href="{{ route('admin.posts.comments',[$post->id,'approved'=>0]) }}">
