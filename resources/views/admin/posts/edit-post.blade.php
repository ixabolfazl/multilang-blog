                        ...
                        <form action="{{ route('admin.posts.store') }}" method="post" class="form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-1">
                                    <x-admin.input name="slug" :label="__('Slug')" :value="$post->slug" tabindex="2"/>
                                </div>
                                <div class="col-6 mb-1">
                                    <div class="row">
                                        <div class="col-md-10">
                                        ...
                                        @if($post->image)
                                            <div class="col-md-2">
                                                <img src="{{ asset($post->image) }}" alt="image" class="user-avatar users-avatar-shadow rounded mr-2 my-25 cursor-pointer" style="max-height: 90px">
                                            </div>
                                        @endif
